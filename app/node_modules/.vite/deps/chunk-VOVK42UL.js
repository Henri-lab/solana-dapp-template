...
var ICONS = {
  add: async () => (await import("./add-6FUXEWEA.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-AAIBPPUA.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-UDPUKNDJ.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-2GPUUY6T.js")).appStoreSvg,
  apple: async () => (await import("./apple-AKMQM44Z.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-XE25C7DG.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-5J6JPB7S.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-WXCQQNEX.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-JPQFKYA6.js")).arrowTopSvg,
  bank: async () => (await import("./bank-HIOR4RFU.js")).bankSvg,
  browser: async () => (await import("./browser-MU2WMT5A.js")).browserSvg,
  card: async () => (await import("./card-DSN7PD2W.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-2LUHDGZO.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-VOKAQUVT.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-AHAFNWTR.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-AAZ2EFH7.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-JXB2TY3X.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-XCFS4PEP.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-PVGERYAW.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-MEUPNVPW.js")).clockSvg,
  close: async () => (await import("./close-YT2NGVVJ.js")).closeSvg,
  compass: async () => (await import("./compass-5LDYRU3N.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-AYRZJLL6.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-DO4WQSUZ.js")).copySvg,
  cursor: async () => (await import("./cursor-TC4I7FGW.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-D4EERI5M.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-X7WT2SIM.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-QTQW3OAU.js")).disconnectSvg,
  discord: async () => (await import("./discord-KZEQNPFC.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-OGNAAWV3.js")).etherscanSvg,
  extension: async () => (await import("./extension-4YR5EKOG.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-MZ5ZHT6K.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-JD6AEUG2.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-IVYEPGGX.js")).farcasterSvg,
  filters: async () => (await import("./filters-ADQBNS2G.js")).filtersSvg,
  github: async () => (await import("./github-5RABHGR3.js")).githubSvg,
  google: async () => (await import("./google-2JR5WDOQ.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-BM54ZMTA.js")).helpCircleSvg,
  image: async () => (await import("./image-JAOAWEBL.js")).imageSvg,
  id: async () => (await import("./id-VX67MMKO.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-U7DAWYBL.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-XUIKNPPU.js")).lightbulbSvg,
  mail: async () => (await import("./mail-LHN7VU25.js")).mailSvg,
  mobile: async () => (await import("./mobile-GTFW4YNJ.js")).mobileSvg,
  more: async () => (await import("./more-3K2QHFJ7.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-LU6OGJNX.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-FWSUXYMM.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-Z44RCSXL.js")).offSvg,
  playStore: async () => (await import("./play-store-PXTKULZS.js")).playStoreSvg,
  plus: async () => (await import("./plus-VLIX5EBR.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-OVG6NW4J.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-D2CDDRYY.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-6C7YZQGJ.js")).refreshSvg,
  search: async () => (await import("./search-J7IJCWAQ.js")).searchSvg,
  send: async () => (await import("./send-YBJ7CMHI.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-7UJCMDZK.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-ERXM7ZIF.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-5PEPMRXF.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-7GJDEAMV.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-H6YOG3TW.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-4NC4TQHH.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-UUMXJIHV.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-PA4MR5QA.js")).twitchSvg,
  twitter: async () => (await import("./x-GHRPHFGA.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-43VKDZ5Y.js")).twitterIconSvg,
  verify: async () => (await import("./verify-77NNFLPB.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-VBDCBA3K.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-FD6JYZLL.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-52GKV2HI.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-52GKV2HI.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-52GKV2HI.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-2WQJHYAA.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-KU3OKQCA.js")).warningCircleSvg,
  x: async () => (await import("./x-GHRPHFGA.js")).xSvg,
  info: async () => (await import("./info-HPX3YKLU.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-AJOWRMEM.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-DJGKOCRL.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VOVK42UL.js.map
