...
} from "./chunk-LWRVCEG2.js";
import {
  require_react
} from "./chunk-QPCSCLY3.js";
import {
  __commonJS,
  __toESM
...
var require_endpoint = __commonJS({
  "../node_modules/@solana/wallet-standard-util/lib/cjs/endpoint.js"(exports) {
    ...
    var wallet_standard_chains_1 = require_cjs();
...
var require_index_browser = __commonJS({
  "../node_modules/@solana-mobile/mobile-wallet-adapter-protocol/lib/cjs/index.browser.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var walletStandardUtil = require_cjs2();
    ...
    function fromUint8Array4(byteArray, urlsafe) {
    ...
    function getRemoteAssociateAndroidIntentURL(associationPublicKey, hostAuthority, reflectorId, associationURLBase, protocolVersions = ["v1"]) {
      return __awaiter4(this, void 0, void 0, function* () {
        ...
        url.searchParams.set("id", `${fromUint8Array4(reflectorId, true)}`);
        protocolVersions.forEach((version) => {
          url.searchParams.set("v", version);
        });
        return url;
    ...
    function transact2(callback, config) {
      return __awaiter4(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
          ...
          const handleOpen = () => __awaiter4(this, void 0, void 0, function* () {
          ...
          const handleError = (_evt) => __awaiter4(this, void 0, void 0, function* () {
            disposeSocket();
          ...
          const handleMessage = (evt) => __awaiter4(this, void 0, void 0, function* () {
            ...
            switch (state.__type) {
              ...
              case "hello_req_sent": {
                ...
                const sessionProperties = sessionPropertiesBuffer.byteLength !== 0 ? yield (() => __awaiter4(this, void 0, void 0, function* () {
                ...
                const wallet = createMobileWalletProxy(sessionProperties.protocol_version, (method, params) => __awaiter4(this, void 0, void 0, function* () {
    ...
    function startRemoteScenario2(config) {
      return __awaiter4(this, void 0, void 0, function* () {
        ...
        let socket;
        let disposeSocket;
        let decodeBytes = (evt) => __awaiter4(this, void 0, void 0, function* () {
          if (encoding == "base64") {
            const message = yield evt.data;
            return toUint8Array3(message).buffer;
          } else {
        ...
        const associationUrl = yield new Promise((resolve, reject) => {
          ...
          const handleReflectorIdMessage = (evt) => __awaiter4(this, void 0, void 0, function* () {
          ...
          const handleMessage = (evt) => __awaiter4(this, void 0, void 0, function* () {
            ...
            switch (state.__type) {
              case "reflector_id_received":
                ...
                if (encoding == "base64") {
                  socket.send(fromUint8Array4(binaryMsg));
                } else {
              ...
              case "hello_req_sent": {
                ...
                const wallet = createMobileWalletProxy(sessionProperties.protocol_version, (method, params) => __awaiter4(this, void 0, void 0, function* () {
                  ...
                  if (encoding == "base64") {
                    socket.send(fromUint8Array4(binaryMsg2));
                  } else {
...
init_index_browser_esm();
var import_mobile_wallet_adapter_protocol = __toESM(require_index_browser());
...
*/
//# sourceMappingURL=chunk-SN5ELHFM.js.map
